...
import 'package:east_bridge/NDPM/NDPMAgreementDownload.dart/NDPMPdfDownloadUpload.dart';
...
class NDPMAgreementCustomerSearch extends StatefulWidget {
  const NDPMAgreementCustomerSearch({super.key, TabController? controller});

  @override
  State<NDPMAgreementCustomerSearch> createState() =>
      DPMAgreementCustomerSearchState();
}

class DPMAgreementCustomerSearchState
    extends State<NDPMAgreementCustomerSearch> {
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          return GestureDetector(
                              onTap: () {
                                ...
                                NDPMPdfDownloadUpload.id.value =
                                    int.parse(key[index]);
                                NDPMPdfDownloadUpload.clientName.value =
                                    li[index];
                                Navigator.of(context).push(MaterialPageRoute(
                                    builder: (context) =>
                                        new NDPMPdfDownloadUpload()));
                                setState(
                                  () {
                                    isCustomerSearch = false;
                                  },
