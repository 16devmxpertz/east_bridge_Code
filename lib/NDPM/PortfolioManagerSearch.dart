...
class PortfolioManagerSearchNDPM extends StatefulWidget {
  const PortfolioManagerSearchNDPM({super.key});

  @override
  State<PortfolioManagerSearchNDPM> createState() =>
      _PortfolioManagerSearchStat();
}

class _PortfolioManagerSearchStat extends State<PortfolioManagerSearchNDPM> {
                  ...
                  child: TextButton(
                    ...
                    child: Row(
                      children: [
                        ...
                        Text(
                          S.of(context).PortfolioManagerSearch,
                          style: TextController.BodyHeadingText,
                        ),
                      ],
                    ),
