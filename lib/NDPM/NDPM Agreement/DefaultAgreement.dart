...
import 'package:east_bridge/NDPM/NDPM%20Agreement/CustomerNDPMAgreement.dart';
...
class NDPMDefaultAgreement extends StatefulWidget {
  @override
...
class _DPMDefaultAgreementState extends State<NDPMDefaultAgreement> {
  ...
  void loadTodoItemsarabic() async {
    ...
    final response = await http.get(
      Uri.parse(
          'https://eastbridge.online/apicore/api/GetDPMAgreements/GetDPMAgreements?AgreementId=2'),
      headers: headers,
    );
  ...
  void senddata() async {
    ...
    var response = await dio.post(
      'https://8.213.23.26:8081/api/NDPMagreements/AddNDPMAgreement',
      data: data,
