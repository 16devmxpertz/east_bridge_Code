...
import 'package:east_bridge/NDPM/NDPM%20Agreement/CustomerNDPMAgreementSearch.dart';
...
//webKYC
class CustomerNDPMAgreement extends StatefulWidget {
  CustomerNDPMAgreement({Key? key}) : super(key: key);

  @override
  State<CustomerNDPMAgreement> createState() => _CustomerDPMAgreementState();
}

class _CustomerDPMAgreementState extends State<CustomerNDPMAgreement>
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    Center(
                                        child: Text(
                                      S.of(context).CustomerNDPMAgreement,
