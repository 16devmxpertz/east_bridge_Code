...
class EditGetAgreementNDPM extends StatefulWidget {
  EditGetAgreementNDPM(@required String x) {
    Id = int.parse(x);
  }

  @override
  _EditGetAgreementState createState() => _EditGetAgreementState();
...
class _EditGetAgreementState extends State<EditGetAgreementNDPM> {
  ...
  void loadTodoItemsarabic() async {
    ...
    print(
        'https://localhost:44323/api/GetNDPMAgreements/GetNDPMAgreements?AgreementId=${Id}');
    final response = await http.get(
      Uri.parse(
          'https://eastbridge.online/apicore/api/GetNDPMAgreements/GetNDPMAgreements?AgreementId=${Id}'),
      headers: headers,
    );
  ...
  void senddata() async {
    ...
    FormData data = FormData.fromMap({
      "ClientId": EditGetAgreementNDPM.clientId.value,
      "EmployeeId": 139,
      "AgreementName": codeDialog,
      "AgreementData": finalitems
    });
    var response = await dio.post(
      'https://8.213.23.26:8081/api/NDPMagreements/LinkAgreementToCostumer',
      data: data,
  ...
  void customerData() async {
    ...
    final response = await http.get(Uri.parse(
        'https://localhost:44323/api/GetClientDataForAgreement?id=${EditGetAgreementNDPM.clientId.value}'));
