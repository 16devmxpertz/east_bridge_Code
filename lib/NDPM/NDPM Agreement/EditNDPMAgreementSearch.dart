...
import 'package:east_bridge/NDPM/NDPM%20Agreement/EditGetNDPMAgreement.dart';
import 'package:east_bridge/NDPM/NDPM%20Agreement/GetAgreement.dart';
...
class EditNDPMAgreementSearch extends StatefulWidget {
  EditNDPMAgreementSearch({super.key, TabController? controller});

  @override
  State<EditNDPMAgreementSearch> createState() =>
      _EditDPMAgreementSearchState();
  static ValueNotifier<int> id = new ValueNotifier(0);
}

class _EditDPMAgreementSearchState extends State<EditNDPMAgreementSearch> {
  List title = [];
  ...
  void fetchData() async {
    ...
    final response = await http.get(Uri.parse(
        'https://eastbridge.online/apicore/api/GetNDPMAgreements/GetNDPMAgreementNames'));

    print("Shah1");
    print(EditNDPMAgreementSearch.id.value);
                    ...
                    child: GestureDetector(
                      onTap: () {
                        Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) =>
                                new EditGetAgreementNDPM(templateKeys)));
                      },
                      child: Icon(
                        Icons.edit,
