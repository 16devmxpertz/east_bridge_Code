...
class CustomerNDPMAgreementSearch extends StatefulWidget {
  CustomerNDPMAgreementSearch({super.key, TabController? controller});

  @override
  State<CustomerNDPMAgreementSearch> createState() =>
      _CustomerDPMAgreementSearchState();
  static ValueNotifier<int> id = new ValueNotifier(0);
}

class _CustomerDPMAgreementSearchState
    extends State<CustomerNDPMAgreementSearch> {
  List title = [];
  ...
  void fetchData() async {
    ...
    print("Shah1");
    print(CustomerNDPMAgreementSearch.id.value);
                  ...
                  Flexible(
                    ...
                    child: GestureDetector(
                      onTap: () {
                        Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) =>
                                new GetAgreementNDPM(templateKeys)));
                      },
                      child: Icon(
                        Icons.edit,
