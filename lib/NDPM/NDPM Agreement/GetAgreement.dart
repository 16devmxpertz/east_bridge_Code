...
class GetAgreementNDPM extends StatefulWidget {
  GetAgreementNDPM(@required String x) {
    Id = int.parse(x);
  }
...
class _GetAgreementState extends State<GetAgreementNDPM> {
  ...
  void senddata() async {
    ...
    FormData data = FormData.fromMap({
      "ClientId": GetAgreementNDPM.clientId.value,
      "EmployeeId": 139,
      "AgreementName": codeDialog,
      "AgreementData": finalitems
    });
    var response = await dio.post(
      'https://eastbridge.online/apicore/api/NDPMagreements/LinkAgreementToCostumer',
      data: data,
  ...
  void customerData() async {
    ...
    final response = await http.get(Uri.parse(
        'https://eastbridge.online/apicore/api/GetClientDataForAgreement?id=${GetAgreementNDPM.clientId.value}'));
