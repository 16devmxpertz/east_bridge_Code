...
class NDPMSellMainSearchComponent extends StatefulWidget {
  const NDPMSellMainSearchComponent({super.key});

  @override
  State<NDPMSellMainSearchComponent> createState() =>
      _DPMSellMainSearchComponentStat();
}

class _DPMSellMainSearchComponentStat
    extends State<NDPMSellMainSearchComponent> {
    ...
    return Container(
      child: Column(
        children: [
          ...
          //                     DPMBuy.persharevalue.value = split[1];
