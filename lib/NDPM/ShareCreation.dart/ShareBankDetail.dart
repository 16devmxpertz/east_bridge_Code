...
import 'package:east_bridge/NDPM/NDPM%20Agreement/DefaultAgreement.dart';
...
class ShareBankDetailsNDPM extends StatefulWidget {
  ShareBankDetailsNDPM({@required controller}) {
    tabController = controller;
  }

  @override
  State<ShareBankDetailsNDPM> createState() => _ShareBankDetailsState();
  static ValueNotifier<int> id = new ValueNotifier(0);
}

TabController? tabController;

class _ShareBankDetailsState extends State<ShareBankDetailsNDPM> {
  ...
  Widget build(BuildContext context) {
    void Fundbank() async {
      var url = Uri.parse(
          'https://eastbridge.online/apicore/api/NDPMShareBankDetail/NDPMShareBankDetail/');
      ...
      try {
        ...
        var body = {
          "shareId": ShareBankDetailsNDPM.id.value,
