...
import 'package:east_bridge/NDPM/NDPM%20Agreement/EditNDPMAgreementSearch.dart';
...
//   @override
//   State<AdvisoryFees> createState() => AdvisoryFeesState();
...
// class AdvisoryFeesState extends State<AdvisoryFees> {
// TextEditingController RangeFrom = new TextEditingController();
// TextEditingController RangeTo = new TextEditingController();
// TextEditingController FixedAdvisoryFees = new TextEditingController();
// TextEditingController AdvisoryFeesRate = new TextEditingController();
...
//   int? fixedAdvisoryFees = int.tryParse(FixedAdvisoryFees.text);
//   int? AdvisoryFeesRate = int.tryParse("AdvisoryFeesRate.text");
//   int? lower = int.tryParse(Lower.text);
//   int? upper = int.tryParse(Upper.text);

//   var url = Uri.parse(
//       'https://eastbridge.online/apicore/api/AdvisoryFeesDetail/AdvisoryFeesDetail');
...
//                     RangeTo.text = "";
//                     PercentOf.text = "";
//                     FixedAdvisoryFees.text = "";
//                     AdvisoryFeesRate.text = "";
//                     dropdownvalue10 = "";
//                     Upper.text = "";
//                     Lower.text = "";
//                   });
...
class ShareFeesDetailNDPM extends StatefulWidget {
  ShareFeesDetailNDPM({@required controller}) {
    tabController = controller;
  }
  @override
...
class _DynamicTableState extends State<ShareFeesDetailNDPM> {
  ...
  void removeRow(int index) {
    setState(() {
      ...
      rowDataList[index].FixedAdvisoryFees.dispose();
      rowDataList[index].AdvisoryFeesRate.dispose();
  ...
  void fundAdvisoryFees() async {
    ...
    for (var rowData in rowDataList) {
      ...
      int fixedFees = int.parse(rowData.FixedAdvisoryFees.text);
      int feesRate = int.parse(rowData.AdvisoryFeesRate.text);
    ...
    var url = Uri.parse(
        'https://eastbridge.online/apicore/api/NDPMShareFeesDetail/NDPMShareFeesDetail');
    ...
    try {
      ...
      var body = {
        "shareId": ShareFeesDetailNDPM.id.value,
        "fees": feesList,
      };
                  ...
                  child: TextButton(
                    onPressed: () {
                      ...
                      Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) => new EditNDPMAgreementSearch()));
                    }, // Switch tabs
                    child: Text(
                      S.of(context).Submit,
                      style: TextController.btnText,
          ...
          TableRow(
            children: [
              ...
              Container(
                ...
                child: TextFormField(
                  textAlign: TextAlign.center,
                  controller: rowDataList[index].FixedAdvisoryFees,
                  maxLines: null,
                  keyboardType: TextInputType.multiline,
                  decoration: InputDecoration(border: InputBorder.none),
                ),
              ...
              Container(
                ...
                child: TextFormField(
                  textAlign: TextAlign.center,
                  controller: rowDataList[index].AdvisoryFeesRate,
                  maxLines: null,
                  keyboardType: TextInputType.multiline,
                  decoration: InputDecoration(border: InputBorder.none),
                ),
