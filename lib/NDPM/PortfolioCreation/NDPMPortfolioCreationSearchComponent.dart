...
import 'package:east_bridge/NDPM/PortfolioCreation/ShareCreation.dart';
import 'package:east_bridge/NDPM/PortfolioCreation/TabOfShareCreation.dart';
import 'package:east_bridge/NDPM/Sell.dart';
...
class NDPMPortfolioCreationSearchComponent extends StatefulWidget {
  const NDPMPortfolioCreationSearchComponent({super.key});

  @override
  State<NDPMPortfolioCreationSearchComponent> createState() =>
      _DPMSellMainSearchComponentStat();
}

class _DPMSellMainSearchComponentStat
    extends State<NDPMPortfolioCreationSearchComponent> {
                  ...
                  child: TextButton(
                    ...
                    onPressed: () {
                      showDialog(
                        context: context,
                        builder: (context) {
                          String clientTypeDropdownValue = 'Individual';
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: [
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            return GestureDetector(
                                onTap: () {
                                  ...
                                  PortfolioCreationNDPM.name.value = li[index];
                                  PortfolioCreationNDPM.id.value =
                                      int.parse(key[index]);
                                  Navigator.of(context).push(MaterialPageRoute(
                                      builder: (context) =>
                                          new TabOfPortfolioCreationNDPM()));
                                  setState(
                                    () {
                                      isCustomerSearch = false;
                                    },
                    ...
                    //               //  customerGetAgreement.id.value=int.parse(key[index]);
                    //               //  tabController!.animateTo(1);
                    //               NDPMSell.name.value = li[index];
                    //               NDPMSell.clientid.value =
                    //                   int.parse(key[index]);
                    //               Navigator.of(context).push(MaterialPageRoute(
                    //                   builder: (context) => new NDPMSell()));
                    //             },
                    //             child: table(li[index], key[index], context));
                    //       },
                    //     ),
