...
class PortfolioFeesDetailNDPM extends StatefulWidget {
  PortfolioFeesDetailNDPM({@required controller}) {
    tabController = controller;
  }
  @override
...
class _DynamicTableState extends State<PortfolioFeesDetailNDPM> {
  ...
  void fundAdvisoryFees() async {
    ...
    var url = Uri.parse(
        'https://eastbridge.online/apicore/api/DPMShareFeesDetail/DPMShareFeesDetail');
    ...
    try {
      ...
      var body = {
        "shareId": PortfolioFeesDetailNDPM.id.value,
        "fees": feesList,
      };
                  ...
                  child: TextButton(
                    onPressed: () {
                      ...
                      Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) => new EditDPMAgreementSearch()));
                    }, // Switch tabs
                    child: Text(
                      S.of(context).Submit,
                      style: TextController.btnText,
