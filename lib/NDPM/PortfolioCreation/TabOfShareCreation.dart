...
class IndividualKYC extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ResponsiveLayout(
      largeScreen: TabOfPortfolioCreationNDPM(),
...
//webKYC
class TabOfPortfolioCreationNDPM extends StatefulWidget {
  const TabOfPortfolioCreationNDPM({Key? key}) : super(key: key);

  @override
  State<TabOfPortfolioCreationNDPM> createState() => TabOfPortfolioCreationNDPMState();
}

class TabOfPortfolioCreationNDPMState extends State<TabOfPortfolioCreationNDPM>
                            ...
                            children: [
                                      ...
                                      child: Center(
                                        child: TabBar(
                                          ...
                                          tabs: [
                                            Tab(
                                              child: Text(
                                                "Portfolio Detail Share Classification",
                              ...
                              Expanded(
                                child: TabBarView(
                                  ...
                                  children: [
                                    PortfolioCreationNDPM(
                                      controller: tabController,
                                    ),

                                    //postalAddress
                                    PortfolioDetailsNDPM(
                                      controller: tabController,
                                    ),

                                    PortfolioFeesDetailNDPM(
                                      controller: tabController,
                                    ),
                                  ],
                                ),
