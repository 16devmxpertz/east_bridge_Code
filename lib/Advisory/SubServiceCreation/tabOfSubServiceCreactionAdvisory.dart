...
import 'package:east_bridge/Advisory/SubServiceCreation/masterServiceSearchAdvisory.dart';
...
class TabOfAdvisorys extends StatelessWidget {
  const TabOfAdvisorys({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return ResponsiveLayout(
      largeScreen: tabOfSubServiceCreactionAdvisory(),
      //mediumScreen: MediumChild(),
      smallScreen: TabOfAdvisorysMob(),
    );
  }
}

//webKYC
class tabOfSubServiceCreactionAdvisory extends StatefulWidget {
  const tabOfSubServiceCreactionAdvisory({Key? key}) : super(key: key);

  @override
  State<tabOfSubServiceCreactionAdvisory> createState() => tabOfSubServiceCreactionAdvisoryState();
}

class tabOfSubServiceCreactionAdvisoryState extends State<tabOfSubServiceCreactionAdvisory>
                            ...
                            children: [
                                      ...
                                      child: Center(
                                        child: TabBar(
                                          ...
                                          tabs: [
                                            ...
                                            // Tab(
                                            //     child: Text(
                                            //   S.of(context).AdvisoryFeesDetails,
                                            //   style:
                              ...
                              Expanded(
                                child: TabBarView(
                                  ...
                                  children: [
                                    masterServiceSearchAdvisory(
                                      controller: tabController,
                                    ),
                                    subServiceCreationAdv(
                                      controller: tabController,
                                    ),
                                    // subServiceAdvisoryFees(
                                    //   controller: tabController,
                                    // ),
                                  ],
                                ),
...
//MobKYC
class TabOfAdvisorysMob extends StatefulWidget {
  const TabOfAdvisorysMob({Key? key}) : super(key: key);

  @override
  State<TabOfAdvisorysMob> createState() => _TabOfAdvisorysMobState();
}

class _TabOfAdvisorysMobState extends State<TabOfAdvisorysMob> {
  @override
  Widget build(BuildContext context) {
