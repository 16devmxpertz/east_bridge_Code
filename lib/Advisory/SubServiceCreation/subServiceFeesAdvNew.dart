...
//   }
//   @override
//   subServiceAdvisoryFeesState createState() => subServiceAdvisoryFeesState();
...
// class subServiceAdvisoryFeesState extends State<subServiceAdvisoryFees> {
...
//     var body = {
//       "advisoryId": GlobalPermissionAdvisory.Advisoryclientid,
//       "fees": feesListfinal,
//     };
...
//       print("Fees Working");
//       GlobalPermissionAdvisory.getdraftprogressAdvisory(
...
//     var url = Uri.parse(
//         '${GlobalPermission.urlLink}/api/AdvisoryFeesDetail/AdvisoryFeesModelUpdate');
...
//     var url = Uri.parse(
//         '${GlobalPermission.urlLink}/api/AdvisoryFeesDetail/AdvisoryFeesModel/$Id'); // Replace with your API endpoint
...
//           li.add(TextEditingController(text: i["calculatedAmount"].toString()));
//          });
...
//     if (GlobalPermissionFund.Funddraftprogress["AdvisoryFeesDetail"] == true) {
//       print("ftechinggg----------");
...
//                                 .Funddraftprogress["AdvisoryFeesDetail"] ==
//                             true) {
