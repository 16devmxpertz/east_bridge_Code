...
class AdvisoryCreations extends StatefulWidget {
  AdvisoryCreations({@required controller}) {
    tabController = controller;
  }

  @override
  State<AdvisoryCreations> createState() => AdvisoryCreationsState();
}
...
class AdvisoryCreationsState extends State<AdvisoryCreations> {
  AdvisoryCreations({@required controller}) {
    tabController = controller;
  }
  ...
  void PutData(int Id) async {
    var url = Uri.parse(
        '${GlobalPermission.urlLink}/AdvisoryCreateService/UpdateAdvisoryService/${Id}');
  ...
  Future<void> fetchData(int Id) async {
    ...
    if (response.statusCode == 200) {
      ...
      setState(() {
        ...
        _duration.text = jsonResponse['duration'];
        dropdownvalue = jsonResponse['industryCategory'];
        dropdownvalue1 = jsonResponse['serviceCategory'];
        dropdownvalue2 = jsonResponse['serviceType'];
      });
    } else {
  ...
  void initState() {
    ...
    if (GlobalPermissionAdvisory
            .Advisorydraftprogress["AdvisoryDetailandClassification"] ==
        true) {
      print("ftechinggg----------");
