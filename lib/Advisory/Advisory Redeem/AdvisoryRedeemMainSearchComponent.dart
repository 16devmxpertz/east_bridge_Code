...
class AdvisoryRedeemMainSearchComponent extends StatefulWidget {
  const AdvisoryRedeemMainSearchComponent({super.key});

  @override
  State<AdvisoryRedeemMainSearchComponent> createState() =>
      _AdvisoryRedeemMainSearchComponentsStat();
}

class _AdvisoryRedeemMainSearchComponentsStat
    extends State<AdvisoryRedeemMainSearchComponent> {
  ...
  void fetchData() async {
    ...
    if (response.statusCode == 200) {
      ...
      li2 = map.values.toList();
      key2 = map.keys.toList();
      print(li2);
      print("Shah3");
    } else {
      print("ShahError");
    ...
    return Container(
      child: Column(
        children: [
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          return GestureDetector(
                              onTap: () {
                                ...
                                // AdvisoryRedeem.name.value = li[index];
                                // AdvisoryRedeem.clientid.value =
                                AdvisoryRedeems.clientid.value =
                                    int.parse(key[index]);
                                AdvisoryRedeems.name.value = li[index];
          ...
          //         return GestureDetector(
          //             onTap: () {
          //               AdvisoryRedeems.id.value = int.parse(key[index]);
          //               AdvisoryRedeems.id.value = int.parse(key[index]);
