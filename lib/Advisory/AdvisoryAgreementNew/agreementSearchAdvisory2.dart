...
class AdvisorygreementSearch2 extends StatefulWidget {
  AdvisorygreementSearch2({super.key, TabController? controller});

  @override
  State<AdvisorygreementSearch2> createState() =>
      _EditAdvisorygreementSearch2State();
  static ValueNotifier<int> id = new ValueNotifier(0);
}

class _EditAdvisorygreementSearch2State extends State<AdvisorygreementSearch2> {
  List title = [];
  ...
  void fetchData() async {
    ...
    print(AdvisorygreementSearch2.id.value);
