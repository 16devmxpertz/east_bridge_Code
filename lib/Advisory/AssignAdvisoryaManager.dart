...
class AssignAdvisoryManager extends StatefulWidget {
  const AssignAdvisoryManager({super.key});

  @override
  State<AssignAdvisoryManager> createState() => _AssignAdvisoryManagerState();
...
class _AssignAdvisoryManagerState extends State<AssignAdvisoryManager> {
  ...
  int currentValue = 0;
  // String value = "";
  //int pershare = int.parse(AssignAdvisoryManager.persharevalue.value);
  ...
  void initState() {
    super.initState();
    NoOfShares.text = "0";
    print(AssignAdvisoryManager.name.value);
    //_calculation();

    setState(() {
      clientName.text = AssignAdvisoryManager.name.value;
      AdvisoryManagerName.text = AssignAdvisoryManager.portname.value;
  ...
  void sendData() async {
    ...
    try {
      ...
      var body = {
        "pmId": AssignAdvisoryManager.pmid.value,
        "clientId": AssignAdvisoryManager.clientid.value
      };
      var response =
                                                        ...
                                                        children: [
                                                          ...
                                                          Flexible(
                                                            child: Container(
                                                              ...
                                                              child:
                                                                  TextFormField(
                                                                //   initialValue: AssignAdvisoryManager.name.value,
                                                                controller:
                                                                    AdvisoryManagerName,
                                                                readOnly: true,
                                                                textAlignVertical:
