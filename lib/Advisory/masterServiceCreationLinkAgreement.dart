...
class masterServiceSearchAdvisoryLinkAgreement extends StatefulWidget {
  masterServiceSearchAdvisoryLinkAgreement({@required controller}) {
    tabController = controller;
  }

  @override
  State<masterServiceSearchAdvisoryLinkAgreement> createState() =>
      masterServiceSearchAdvisoryLinkAgreementState();
}
...
class masterServiceSearchAdvisoryLinkAgreementState
    extends State<masterServiceSearchAdvisoryLinkAgreement> {
  masterServiceSearchAdvisoryLinkAgreement({@required controller}) {
    tabController = controller;
  }
                ...
                Container(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      ...
                      MileStoneFees.id.value = id;
                      Scopeofwork.id.value = id;
                      AdvisoryDetailss.id.value = id;
                      GlobalPermissionAdvisory.AdvisoryIdService = id;
                      GlobalPermissionAdvisory.AdvisoryServiceNameGlobal = node;
                  ...
                  return Container(
                    child: SingleChildScrollView(
                      child: Column(
                        children: [
                          if (childs.length > 0)
                            generateItems(childs[index], treedic[childs[index]],
                                ml + 10, false),
                        ],
                      ),
                    ),
