...
class AdvisoryManagerSearch extends StatefulWidget {
  const AdvisoryManagerSearch({super.key});

  @override
  State<AdvisoryManagerSearch> createState() => _AdvisoryManagerSearchStat();
}

class _AdvisoryManagerSearchStat extends State<AdvisoryManagerSearch> {
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          return GestureDetector(
                              onTap: () {
                                ...
                                AssignAdvisoryManager.name.value = li[index];
                                AssignAdvisoryManager.clientid.value =
                                    int.parse(key[index]);
                                Navigator.of(context).push(MaterialPageRoute(
                                    builder: (context) =>
                                        new AssignAdvisoryManager()));
                                setState(
                                  () {
                                    isCustomerSearch = false;
                                  },
