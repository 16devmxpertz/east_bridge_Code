...
class ADSearch extends StatefulWidget {
  ADSearch({super.key, TabController? controller});
                ...
                children: [
                  TableRow(children: [
                    Container(
                        ...
                        child: Center(
                            child: Text(
                          S.of(context).AdvisoryManagerId,
                    ...
                    Container(
                        ...
                        child: Center(
                            child: Text(
                          S.of(context).AdvisoryManagerName,
                          style: TextController.tableHeading,
                        ))),
                  ]),
                ],
              ...
              child: ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  return GestureDetector(
                      onTap: () {
                        AssignAdvisoryManager.portname.value = li[index];
                        AssignAdvisoryManager.pmid.value =
                            int.parse(key[index]);
