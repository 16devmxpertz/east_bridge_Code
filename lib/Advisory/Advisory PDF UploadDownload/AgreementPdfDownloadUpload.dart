...
class AdvisoryAgreementPdfDownloadUpload extends StatefulWidget {
  @override
  AdvisoryAgreementPdfDownloadUploadState createState() => AdvisoryAgreementPdfDownloadUploadState();
...
class AdvisoryAgreementPdfDownloadUploadState extends State<AdvisoryAgreementPdfDownloadUpload> {
  double yOffset = 0;
  double xOffset = 0;
  ...
  void clientIdentification() async {
    print("Shah");
    print({AdvisoryAgreementPdfDownloadUpload.id.value});

    final response = await http.post(Uri.parse(
        '${GlobalPermission.urlLink}/api/ClientIdentificationApi/ClientIdentification?id=${AdvisoryAgreementPdfDownloadUpload.id.value}'));
  ...
  Future<void> uploadPdf1() async {
    if (AdvisoryAgreementPdfDownloadUpload.id.value != 0) {
  ...
  Future<void> uploadPdfIndividual() async {
    FormData data = FormData.fromMap({
      'ClientId': AdvisoryAgreementPdfDownloadUpload.id.value,
                                  ...
                                  Container(
                                    ...
                                    child: TextButton(
                                      onPressed: () {
                                        // Navigator.of(context)
                                        //     .push(MaterialPageRoute(
                                        //   builder: (context) => AdvisoryAgreementPdfDownloadUpload(),
                                        // ));
                                      },
                                      child: Container(
                                        //color: ColorSelect.east_blue,
                                ...
                                children: [
                                  ...
                                  Align(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Text(
                                        "Client Name : " +
                                            AdvisoryAgreementPdfDownloadUpload.name.value,
                                          ...
                                          children: [
                                            Container(
                                              ...
                                              child: TextButton(
                                                onPressed: () {
                                                  reportsDownloadKYC(
                                                      AdvisoryAgreementPdfDownloadUpload.id.value,
                                                      clientType);
                                                },
                                                child: Text(
                                                  S.of(context).Download,
