...
import 'package:east_bridge/Advisory/ADSearch.dart';
import 'package:east_bridge/Advisory/AssignAdvisoryaManager.dart';
import 'package:east_bridge/Advisory/ExpenseTrackerScreenAdvisory.dart';
...
import 'package:east_bridge/DPM/PMSearch.dart';
...
class AdvisoryManagerSearchforExpenseTracker extends StatefulWidget {
  const AdvisoryManagerSearchforExpenseTracker({super.key});

  @override
  State<AdvisoryManagerSearchforExpenseTracker> createState() =>
      _AdvisoryManagerSearchforExpenseTrackerStat();
}

class _AdvisoryManagerSearchforExpenseTrackerStat
    extends State<AdvisoryManagerSearchforExpenseTracker> {
  ...
  void fundSearch() async {
    ...
    var response = await dio1.post(
      'https://localhost:44323/api/Search/FundSearch',
      data: data,
      onSendProgress: (int sent, int total) {
        print('$sent $total');
      },
                  ...
                  child: TextButton(
                    ...
                    child: Row(
                      children: [
                        ...
                        // Text(
                        //   S.of(context).AdvisoryManagerSearch,
                        //   style: TextController.BodyHeadingText,
                        // ),
                      ],
                    ),
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          return GestureDetector(
                              onTap: () {
                                ExpenseTrackerAdvisory.clientName.value =
                                    li[index];
                                ExpenseTrackerAdvisory.id.value =
                                    int.parse(key[index]);
                                Navigator.of(context).push(MaterialPageRoute(
                                    builder: (context) =>
                                        new ExpenseTrackerAdvisory()));
                                setState(
                                  () {
                                    isCustomerSearch = false;
                                  },
