...
class customerGetAdvisoryAgreement extends StatefulWidget {
  customerGetAdvisoryAgreement(@required String x) {
    Id1 = int.parse(x);
  }

  @override
  customerGetAdvisoryAgreementState createState() =>
      customerGetAdvisoryAgreementState();
  static ValueNotifier<int> id = ValueNotifier(0);
}

int Id1 = customerGetAdvisoryAgreement.id.value;

class customerGetAdvisoryAgreementState
    extends State<customerGetAdvisoryAgreement> {
  ...
  void loadTodoItemsarabic(int id) async {
    ...
    final response = await http.get(
      Uri.parse(
          '${GlobalPermission.urlLink}/api/AdvisoryAgreeementCreation/GetAdvisoryAgreementTemplatebyId?agreementId=${Id1}'),
      headers: headers,
    );
  ...
  void sendData() async {
    var url = Uri.parse(
        'http://8.213.23.26:8081/apicore/api/CustomerAgreement/CustomerAgreementRelation/');
    ...
    try {
      ...
      var body = {
        "customerId": customerGetAdvisoryAgreement.id.value,
        "templateId": Id1
      };
  ...
  void customerData() async {
    ...
    final response = await http.get(Uri.parse(
        'http://8.213.23.26:8081/apicore/api/GetClientDataForAgreement?id=${customerGetAdvisoryAgreement.id.value}'));
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        padding: const EdgeInsets.all(10),
                        child: Text("Client Name :   ${li[1]}    : اسم العميل"),
                      ),
                      Padding(
                        padding: const EdgeInsets.all(10),
                        child: Text("Address  :    ${li[2]}     :   عنوان"),
                      ),
                      Padding(
                        padding: const EdgeInsets.all(10),
                        child: Text(
                      ...
                      Padding(
                        padding: const EdgeInsets.all(10),
                        child: Text("Email    :   ${li[4]}   :  بريد إلكتروني"),
                      ),
