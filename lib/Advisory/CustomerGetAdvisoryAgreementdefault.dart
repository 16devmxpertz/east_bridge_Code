...
class customerGetAdvisoryAgreementdefault extends StatefulWidget {
  customerGetAdvisoryAgreementdefault(int value);

  @override
  _customerGetAdvisoryAgreementdefaultState createState() =>
      _customerGetAdvisoryAgreementdefaultState();
...
class _customerGetAdvisoryAgreementdefaultState
    extends State<customerGetAdvisoryAgreementdefault> {
  ...
  void loadTodoItemsarabic() async {
    ...
    final response = await http.get(
      Uri.parse(
          '${GlobalPermission.urlLink}/api/AdvisoryAgreeementCreation/GetAdvisoryAgreementTemplatebyId?agreementId=${id}'),
      headers: headers,
    );
  ...
  void senddata() async {
    ...
    FormData data = FormData.fromMap({
      "generatedBy": 0,
      "AdvisoryId": customerGetAdvisoryAgreementdefault.id.value,
      "TemplateName": codeDialog,
      "todos": finalitems
    });
    var response = await dio.post(
      '${GlobalPermission.urlLink}/api/AdvisoryAgreeementCreation/AdvisoryAgreementTemplates',
      data: data,
