...
import 'package:east_bridge/Advisory/AdvisorySearchArrangingManage.dart';
...
class AdvisoryManagerSearchNDPM extends StatefulWidget {
  const AdvisoryManagerSearchNDPM({super.key});

  @override
  State<AdvisoryManagerSearchNDPM> createState() =>
      _AdvisoryManagerSearchStat();
}

class _AdvisoryManagerSearchStat extends State<AdvisoryManagerSearchNDPM> {
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          return GestureDetector(
                              onTap: () {
                                ...
                                AssignAdvisoryManagerNDPM.name.value =
                                    li[index];
                                AssignAdvisoryManagerNDPM.clientid.value =
                                    int.parse(key[index]);
