...
class masterServiceSearchAdvisoryforLinkAgreement extends StatefulWidget {
  masterServiceSearchAdvisoryforLinkAgreement({@required controller}) {
    tabController = controller;
  }

  @override
  State<masterServiceSearchAdvisoryforLinkAgreement> createState() =>
      masterServiceSearchAdvisoryforLinkAgreementState();
}
...
class masterServiceSearchAdvisoryforLinkAgreementState
    extends State<masterServiceSearchAdvisoryforLinkAgreement> {
  masterServiceSearchAdvisoryforLinkAgreement({@required controller}) {
    tabController = controller;
  }
