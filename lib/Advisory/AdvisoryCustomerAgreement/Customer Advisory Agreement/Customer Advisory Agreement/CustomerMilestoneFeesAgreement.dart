...
import 'package:east_bridge/Advisory/AdvisoryCustomerAgreement/Customer%20Advisory%20Agreement/Customer%20Advisory%20Agreement/Customer%20Advisory%20Components/masterServiceSearchAdvisoryforLinkAgreementwithCustomer.dart';
import 'package:east_bridge/Advisory/AdvisoryCustomerAgreement/Customer%20Advisory%20Agreement/Customer%20Advisory%20Agreement/CustomerAdvisoryFees.dart';
import 'package:east_bridge/Advisory/AdvisoryCustomerAgreement/Customer%20Advisory%20Agreement/Customer%20Advisory%20Agreement/ScopeofworkArranging.dart';
...
class AdvisoryAgreement extends StatefulWidget {
  AdvisoryAgreement({Key? key}) : super(key: key);

  @override
  State<AdvisoryAgreement> createState() => _CustomerDPMAgreementState();
}

class _CustomerDPMAgreementState extends State<AdvisoryAgreement>
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    Center(
                                        child: Text(
                                      S.of(context).CustomerAdvisoryAgreement,
                                      ...
                                      child: Material(
                                        child: TabBar(
                                          ...
                                          tabs: [
                                            ...
                                            // Tab(
                                            //     child: Text(
                                            //   S.of(context).AdvisoryAgreement,
                                            //   style:
                                            //       TextController.TabHeadingText,
                                            // )),
                                          ],
                                ...
                                Expanded(
                                  child: TabBarView(
                                    ...
                                    children: [
                                      ...
                                      masterServiceSearchAdvisoryforLinkAgreement(
                                        controller: tabController,
                                      ),
                                      AdvisoryDetailss(
                                        controller: tabController,
