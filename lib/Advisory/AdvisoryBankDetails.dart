...
class AdvisoryBankDetails extends StatefulWidget {
  AdvisoryBankDetails({@required controller}) {
    tabController = controller;
  }

  @override
  State<AdvisoryBankDetails> createState() => _AdvisoryBankDetailsState();
  static ValueNotifier<int> id = new ValueNotifier(0);
}

TabController? tabController;

class _AdvisoryBankDetailsState extends State<AdvisoryBankDetails> {
  ...
  Widget build(BuildContext context) {
    void Fundbank() async {
      var url = Uri.parse(
          'http://8.213.23.26:8081/apicore/api/AdvisoryBankDetail/AdvisoryBankDetail');
      ...
      try {
        ...
        var body = {
          "advisoryId": AdvisoryBankDetails.id.value,
