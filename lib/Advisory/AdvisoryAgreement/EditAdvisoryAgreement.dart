...
import '../AdvisoryCustomerAgreement/Customer Advisory Agreement/Customer Advisory Agreement/CustomerMilestoneArrangingFeesAgreement.dart';

//import 'package:todo/Colors.dart';

class EditDefaulAgreementCreation extends StatefulWidget {
  EditDefaulAgreementCreation({@required controller}) {
    tabController = controller;
  }
  @override
  _EditDefaulAgreementCreationState createState() =>
      _EditDefaulAgreementCreationState();

  static ValueNotifier<int> AdvisoryId = ValueNotifier(0);
}

TabController? tabController;

class _EditDefaulAgreementCreationState
    extends State<EditDefaulAgreementCreation> {
  ...
  void loadTodoItems() async {
    ...
    final response = await http.get(
      Uri.parse(
          '${GlobalPermission.urlLink}/api/ClientAdvisoiryAgreementLink/GetadvisoryAgreementByAgreementId?AgreementId=${EditDefaulAgreementCreation.AdvisoryId.value}'),
      headers: headers,
    );
