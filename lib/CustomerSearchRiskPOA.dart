...
class CustomerSearchRiskPOA extends StatefulWidget {
  const CustomerSearchRiskPOA({super.key});

  @override
  State<CustomerSearchRiskPOA> createState() => _CustomerSearchRiskPOAStat();
}

class _CustomerSearchRiskPOAStat extends State<CustomerSearchRiskPOA> {
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return GestureDetector(
                            onTap: () {
                              RiskFormPOA.clientID.value =
                                  int.parse(key[index]);
                              RiskFormPOA.clientName.value = li[index];
                              RiskFormPOA.send.value = false;
                              Navigator.of(context).push(MaterialPageRoute(
                                  builder: (context) => new RiskFormPOA()));
                            },
