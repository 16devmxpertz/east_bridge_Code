...
class OfficeSettingsMain extends StatefulWidget {
  const OfficeSettingsMain({super.key});

  @override
  State<OfficeSettingsMain> createState() => _OfficeSettingsMainState();
}

class _OfficeSettingsMainState extends State<OfficeSettingsMain> {
  TextEditingController addOfficeNameEN = new TextEditingController();
  TextEditingController addOfficeNameAR = new TextEditingController();
  TextEditingController addOfficeAddEN = new TextEditingController();
  TextEditingController addOfficeAddAr = new TextEditingController();
  String BranchPop = "";
  String BranchName = "";
  var BranchList = [""];
  ...
  void postdata() async {
    var url = Uri.parse(
        '${GlobalPermission.urlLink}/api/EastBridgeBranches/AddOffice');
    ...
    try {
      ...
      var body = {
        "officeId": 10,
        "officenameEnglish": addOfficeNameEN.text,
        "officenameArabic": addOfficeNameAR.text,
        "branchId": (li1.indexOf(BranchPop) + 1),
        "officeAddressEnglish": addOfficeAddEN.text,
        "officeAddressArabic": addOfficeAddAr.text
      };
      ...
      if (response.statusCode == 200) {
        ...
        addOfficeAddAr.text = "";
        addOfficeAddEN.text = "";
        addOfficeNameAR.text = "";
        addOfficeNameEN.text = "";
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: DropdownButton(
                        hint: Text("Select here",
                            style: TextController.labelText),
                        value: BranchName.isNotEmpty ? BranchName : null,
                        isExpanded: true,
                        underline: Container(),
                          ...
                          setState(
                            () {
                              if (NewValue != null && NewValue.isNotEmpty) {
                                BranchName = NewValue;
                                getOfficeList(li1.indexOf(NewValue) + 1);
                              }
                            },
                          );
                        },
            ...
            TableRow(
              children: [
                Container(
                  ...
                  alignment: Alignment.center,
                  child: Text(
                    officeData[index]["officeId"].toString(),
                    style: TextController.BodyText,
                  ),
                ),
                Container(
                  ...
                  alignment: Alignment.center,
                  child: Text(
                    officeData[index]["officenameEnglish"],
                    style: TextController.BodyText,
                  ),
                ),
                Container(
                  ...
                  alignment: Alignment.center,
                  child: Text(
                    officeData[index]["officenameArabic"],
                    style: TextController.BodyText,
                  ),
                ),
                Container(
                  ...
                  alignment: Alignment.center,
                  child: Text(
                    officeData[index]["officeAddressEnglish"],
                    style: TextController.BodyText,
                  ),
                ),
                Container(
                  ...
                  alignment: Alignment.center,
                  child: Text(
                    officeData[index]["officeAddressArabic"],
                    style: TextController.BodyText,
                  ),
                ),
              ],
