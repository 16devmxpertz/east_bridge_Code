...
class FundReedemMainSearchComponent extends StatefulWidget {
  const FundReedemMainSearchComponent({super.key});

  @override
  State<FundReedemMainSearchComponent> createState() =>
      _FundReedemMainSearchComponentsStat();
}

class _FundReedemMainSearchComponentsStat
    extends State<FundReedemMainSearchComponent> {
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          return GestureDetector(
                              onTap: () {
                                ...
                                clientId = int.parse(key[index]);
                                FundReedem.name.value = li[index];
                                FundReedem.clientid.value =
                                    int.parse(key[index]);
                                Navigator.of(context).push(MaterialPageRoute(
                                    builder: (context) => new FundReedem()));
                                setState(
                                  () {
                                    isCustomerSearch = false;
                                  },
