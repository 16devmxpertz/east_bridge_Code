...
class ArrangingArrangingSelecion extends StatefulWidget {
  @override
  State<ArrangingArrangingSelecion> createState() => ArrangingArrangingSelecionState();
}

class ArrangingArrangingSelecionState extends State<ArrangingArrangingSelecion> {
  double yOffset = 0;
  double xOffset = 0;
