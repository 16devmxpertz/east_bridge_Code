...
class ArrangingAgreement extends StatefulWidget {
  @override
  ArrangingAgreementState createState() => ArrangingAgreementState();
}

class ArrangingAgreementState extends State<ArrangingAgreement> {
  double yOffset = 0;
  double xOffset = 0;
