import 'package:east_bridge/Arranging/Arranging%20Agreement%20Search/ArrangingTemlpateSearch.dart';
...
import 'package:east_bridge/Arranging/ArrangingCustomerAgreement/Customer%20Arranging%20Agreement/Customer%20Arranging%20Agreement/CustomerArrangingFees.dart';
import 'package:east_bridge/Arranging/ArrangingCustomerAgreement/Customer%20Arranging%20Agreement/Customer%20Arranging%20Agreement/ScopeofworkArranging.dart';
...
//webKYC
class ArrangingAgreementLink extends StatefulWidget {
  ArrangingAgreementLink({Key? key}) : super(key: key);

  @override
  State<ArrangingAgreementLink> createState() => _CustomerDPMAgreementState();
}

class _CustomerDPMAgreementState extends State<ArrangingAgreementLink>
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    Center(
                                        child: Text(
                                      S.of(context).CustomerArrangingAgreement,
                                ...
                                Expanded(
                                  child: TabBarView(
                                    ...
                                    children: [
                                      ...
                                      MileStoneFeesArranging(
                                      controller: tabController,
                                    ),

                                      ScopeofworkArranging(
                                      controller: tabController,
                                    ),
                                      ...
                                      //income&netWorth
                                      ArrangingDefaultdatalanaAgreement(
                                        controller: tabController,
                                      ),
