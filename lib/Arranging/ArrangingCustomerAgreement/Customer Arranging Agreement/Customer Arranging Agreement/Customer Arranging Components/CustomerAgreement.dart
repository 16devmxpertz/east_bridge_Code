...
class customerAgreementArr extends StatefulWidget {
  customerAgreementArr({@required controller}) {
    tabController = controller;
  }
  @override
  customerAgreementArrState createState() => customerAgreementArrState();
}

class customerAgreementArrState extends State<customerAgreementArr> {
  ...
  void loadTodoItemsarabic() async {
    ...
    final response = await http.get(
      Uri.parse('https://localhost:7039/api/TandCDynamic/DefaultTandCGet'),
      headers: headers,
    );
  ...
  void senddata() async {
    ...
    int n = finalitems.length;
     ...
     "GenetaredBy" : 139,
      ...
      'https://localhost:7039/api/AgreementTemplate/AgreementTemplates',
      data: data,
