...
class FundDetailsBArr extends StatefulWidget {
FundDetailsBArr({@required controller}) {
    tabController = controller;
  }

  @override
  State<FundDetailsBArr> createState() => _FundDetailsBArrState();
}

TabController? tabController;

class _FundDetailsBArrState extends State<FundDetailsBArr> {
