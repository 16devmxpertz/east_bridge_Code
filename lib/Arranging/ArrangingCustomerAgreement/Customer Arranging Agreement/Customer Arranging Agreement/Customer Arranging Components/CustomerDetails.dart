...
class CustomerDetailsArr extends StatefulWidget {
  CustomerDetailsArr({@required controller}) {
    tabController = controller;
  }

  @override
  State<CustomerDetailsArr> createState() => _CustomerDetailsArrState();
}

TabController? tabController;

class _CustomerDetailsArrState extends State<CustomerDetailsArr> {
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Container(
                child: Text(
                  S.of(context).CustomerDetailsArr,
