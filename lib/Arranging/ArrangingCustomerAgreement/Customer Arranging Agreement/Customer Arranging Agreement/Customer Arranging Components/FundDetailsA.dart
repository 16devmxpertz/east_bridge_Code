...
class FundDetailsAArr extends StatefulWidget {
FundDetailsAArr({@required controller}) {
    tabController = controller;
  }

  @override
  State<FundDetailsAArr> createState() => _FundDetailsAArrState();
}

TabController? tabController;

class _FundDetailsAArrState extends State<FundDetailsAArr> {
