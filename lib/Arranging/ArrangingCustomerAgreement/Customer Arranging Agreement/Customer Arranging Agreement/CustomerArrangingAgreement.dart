...
import '../../../ArrangingAgreement/DefaultAgreement.dart';


//webKYC
class AdvisoryAgreementArranging extends StatefulWidget {
  AdvisoryAgreementArranging({Key? key}) : super(key: key);

  @override
  State<AdvisoryAgreementArranging> createState() => _CustomerDPMAgreementState();
}

class _CustomerDPMAgreementState extends State<AdvisoryAgreementArranging>
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    Center(
                                        child: Text(
                                      S.of(context).AdvisoryAgreementArranging,
