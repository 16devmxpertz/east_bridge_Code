...
class ClientArrangingAgreementSearch extends StatefulWidget {
  ClientArrangingAgreementSearch({super.key, TabController? controller});

  @override
  State<ClientArrangingAgreementSearch> createState() =>
      _AgreementSearchState();
  static ValueNotifier<int> id = new ValueNotifier(0);
}

class _AgreementSearchState extends State<ClientArrangingAgreementSearch> {
  List title = [];
  ...
  void fetchData() async {
    ...
    print("Shah1");
    print(ClientArrangingAgreementSearch.id.value);
