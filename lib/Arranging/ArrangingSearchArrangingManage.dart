...
class AdSearchArr extends StatefulWidget {
  AdSearchArr({super.key, TabController? controller});

  @override
  State<AdSearchArr> createState() => _AdSearchArrState();
  static ValueNotifier<int> id = new ValueNotifier(0);
}

class _AdSearchArrState extends State<AdSearchArr> {
  List title = [];
  ...
  void fetchData() async {
    ...
    final response = await http.get(Uri.parse(
        'http://8.213.23.26:8081/apicore/api/GetAdvisorManager/GetAdvisorManager'));

    print("Shah1");
    print(AdSearchArr.id.value);
                ...
                children: [
                  TableRow(children: [
                    ...
                    Container(
                        ...
                        child: Center(
                            child: Text(
                          S.of(context).AdvisorManagerName,
                          style: TextController.tableHeading,
                        ))),
                  ]),
                ],
              ...
              child: ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  return GestureDetector(
                      onTap: () {
                        //  AssignAdvisorManagerNDPM.portname.value = li[index];
                        //  AssignAdvisorManagerNDPM.pmid.value =
                        int.parse(key[index]);
                        Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) =>
                                new ArrangingManagerSearchNDPM()));
                      },
