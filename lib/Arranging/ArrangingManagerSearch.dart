...
import 'package:east_bridge/Arranging/ArrangingSearchArrangingManage.dart';
...
import 'package:east_bridge/NDPM/PMSearchNDPM.dart';
...
class ArrangingManagerSearchNDPM extends StatefulWidget {
  const ArrangingManagerSearchNDPM({super.key});

  @override
  State<ArrangingManagerSearchNDPM> createState() =>
      _PortfolioManagerSearchStat();
}

class _PortfolioManagerSearchStat extends State<ArrangingManagerSearchNDPM> {
      ...
      child: Column(
        children: [
                  ...
                  child: TextButton(
                    ...
                    child: Row(
                      children: [
                        ...
                        Text(
                          S.of(context).ArrangingManagerSearch,
                          style: TextController.BodyHeadingText,
                        ),
                      ],
                    ),
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          return GestureDetector(
                              onTap: () {
                                ...
                                AssignPortfolioManagerNDPM.name.value =
                                    li[index];
                                AssignPortfolioManagerNDPM.clientid.value =
                                    int.parse(key[index]);
          ...
          if (isFundSearch)
            ...
            //                     // print(split);
            //                     // FundSubscribe.fundname.value = split[0];
            //                     // FundSubscribe.persharevalue.value = split[1];
            //                     // FundSubscribe.fundid.value =
            //                     //     int.parse(fkey[index]);

            //                     // Navigator.of(context).push(MaterialPageRoute(
            //                     //     builder: (context) => new FundSubscribe()));
            //                   },
