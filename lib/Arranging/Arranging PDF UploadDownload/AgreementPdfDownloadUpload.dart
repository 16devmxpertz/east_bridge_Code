...
class ArrangingAgreementPdfDownloadUpload extends StatefulWidget {
  @override
  ArrangingAgreementPdfDownloadUploadState createState() =>
      ArrangingAgreementPdfDownloadUploadState();
...
class ArrangingAgreementPdfDownloadUploadState
    extends State<ArrangingAgreementPdfDownloadUpload> {
  double yOffset = 0;
  double xOffset = 0;
  ...
  void getAgreementList() async {
    ...
    var url = Uri.parse(
        'http://8.213.23.26:8081/apicore/api/GetAgreementNameByclientId/GetTemplateNamesByClientId?CustomerId=${ArrangingAgreementPdfDownloadUpload.id.value}');
  ...
  void initState() {
    ...
    setState(() {
      clientName.text = ArrangingAgreementPdfDownloadUpload.clientName.value;
    });
    getAgreementList();
  }
  ...
  void agreementDownload() async {
    ...
    var downloadUrl =
        'http://8.213.23.26:8081/apicore/api/FetchasPDF/FetchPDF?templateId=${key1}';
  ...
  Future<void> uploadPdf() async {
    ...
    if (result != null) {
      ...
      FormData data = FormData.fromMap({
        'ClientId': ArrangingAgreementPdfDownloadUpload.id.value,
        'AgreementId': key1,
        'CheckBoxPdf': MultipartFile.fromBytes(fileBytes, filename: fileName),
      });

      var response = await dio.post(
        "https://localhost:44323/api/AgreementPdfUpload/AgreementPdf/",
        data: data,
