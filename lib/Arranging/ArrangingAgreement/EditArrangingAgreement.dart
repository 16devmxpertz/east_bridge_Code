...
class EditArrangingGetAgreement extends StatefulWidget {
  EditArrangingGetAgreement(@required String x) {
    Id = int.parse(x);
  }

  @override
  _EditArrangingGetAgreementState createState() =>
      _EditArrangingGetAgreementState();
...
class _EditArrangingGetAgreementState extends State<EditArrangingGetAgreement> {
  ...
  void loadTodoItemsarabic() async {
    ...
    print(
        'http://8.213.23.26:8081/apicore/api/GetDPMAgreements/GetDPMAgreements?AgreementId=${Id}');
  ...
  void senddata() async {
    ...
    FormData data = FormData.fromMap({
      "ClientId": EditArrangingGetAgreement.clientId.value,
      "EmployeeId": 139,
      "AgreementName": codeDialog,
      "AgreeemntData": finalitems
    });
    var response = await dio.post(
      'http://8.213.23.26:8081/apicore/api/DPMagreements/LinkAgreementToCostumer',
      data: data,
  ...
  //       'http://8.213.23.26:8081/apicore/api/GetClientDataForAgreement?id=${EditArrangingGetAgreement.clientId.value}'));
