...
class customerGetArrangingAgreement extends StatefulWidget {
  customerGetArrangingAgreement(@required String x) {
    Id1 = int.parse(x);
  }

  @override
  customerGetArrangingAgreementState createState() =>
      customerGetArrangingAgreementState();
  static ValueNotifier<int> id = ValueNotifier(0);
}

int Id1 = customerGetArrangingAgreement.id.value;

class customerGetArrangingAgreementState
    extends State<customerGetArrangingAgreement> {
  ...
  void loadTodoItemsarabic(int id) async {
    print(
        'http://8.213.23.26:8081/apicore/api/ArrangingAgreementTemplate/ArrangingAgreementTemplatesGet?templateid=${Id1}');
  ...
  void sendData() async {
    ...
    try {
      ...
      var body = {
        "customerId": customerGetArrangingAgreement.id.value,
        "templateId": Id1
      };
  ...
  void customerData() async {
    ...
    final response = await http.get(Uri.parse(
        'http://8.213.23.26:8081/apicore/api/GetClientDataForAgreement?id=${customerGetArrangingAgreement.id.value}'));
