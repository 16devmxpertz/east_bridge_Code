...
class MileStoneSearchArranging extends StatefulWidget {
  const MileStoneSearchArranging({super.key, TabController? controller});

  @override
  State<MileStoneSearchArranging> createState() =>
      _MileStoneSearchArrangingsStat();
}

class _MileStoneSearchArrangingsStat extends State<MileStoneSearchArranging> {
  bool isCustomerSearch = true;
  Map<String, bool> checkboxStates = {};
  List<String> isCheckedsdd = ["",""];
  ...
  void initState() {
    super.initState();
    checkboxStates = {};
    for (var value in isCheckedsdd) {
      checkboxStates[value] = false; // Initialize all checkboxes as unchecked
    }
    //fetchData();
  }
            ...
            child: ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                return GestureDetector(
                    ...
                    child: table("li[index]", "key[index]",
                        checkboxStates[index]!, context));
              },
            ),
          ),
        ],
  ...
  Widget table(String templateName, String templateKeys, bool check,
