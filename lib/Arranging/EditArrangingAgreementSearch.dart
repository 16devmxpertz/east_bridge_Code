...
import 'package:east_bridge/Arranging/ArrangingAgreement/EditArrangingAgreement.dart';
...
class EditArranginggreementSearch extends StatefulWidget {
  EditArranginggreementSearch({super.key, TabController? controller});

  @override
  State<EditArranginggreementSearch> createState() =>
      _EditArranginggreementSearchState();
  static ValueNotifier<int> id = new ValueNotifier(0);
}

class _EditArranginggreementSearchState
    extends State<EditArranginggreementSearch> {
  List title = [];
  ...
  void fetchData() async {
    ...
    print("Shah1");
    print(EditArranginggreementSearch.id.value);
                                            ...
                                            child: TextButton(
                                              ...
                                              onPressed: () {
                                                Navigator.of(context).push(
                                                    MaterialPageRoute(
                                                        builder: (context) =>
                                                            new ArrangingDefaultdatalanaAgreement()));
                                              },
                                              child: Text(
