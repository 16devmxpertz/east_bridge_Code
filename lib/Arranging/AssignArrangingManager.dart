...
import 'package:east_bridge/Arranging/ArrangingManagerSearch.dart';
...
import 'package:east_bridge/NDPM/Buy.dart';
import 'package:east_bridge/NDPM/PortfolioManagerSearch.dart';
...
class AssignArrangingManagerNDPM extends StatefulWidget {
  const AssignArrangingManagerNDPM({super.key});

  @override
  State<AssignArrangingManagerNDPM> createState() =>
      _AssignArrangingManagerNDPMState();
...
class _AssignArrangingManagerNDPMState
    extends State<AssignArrangingManagerNDPM> {
  ...
  int currentValue = 0;
  // String value = "";
  //int pershare = int.parse(AssignArrangingManagerNDPM.persharevalue.value);
  ...
  void initState() {
    super.initState();
    NoOfShares.text = "0";
    print(AssignArrangingManagerNDPM.name.value);
    //_calculation();

    setState(() {
      clientName.text = AssignArrangingManagerNDPM.name.value;
      _PortfolioManagerName.text = AssignArrangingManagerNDPM.portname.value;
  ...
  List list = [];
  void sendDataNDPM() async {
    var url = Uri.parse(
        'https://eastbridge.online/apicore/api/PortFolioManagerNDPMClientRelation/PortFolioManagerClientRelationNDPM/');
    ...
    try {
      ...
      var body = {
        "pmId": AssignArrangingManagerNDPM.pmid.value,
        "clientId": AssignArrangingManagerNDPM.clientid.value
      };
      var response =
                                                        ...
                                                        decoration: BoxDecoration(
                                                            ...
                                                            border: Border.all(
                                                                color: ColorSelect
                                                                    .textField)),
                                                        child: TextFormField(
                                                          //   initialValue: AssignArrangingManagerNDPM.name.value,
                                                          controller:
