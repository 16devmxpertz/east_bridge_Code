...
//   var url = Uri.parse(
//       'http://8.213.23.26:8081/apicore/api/AdvisoryFeesDetail/AdvisoryFeesDetail');
...
class subServiceArrangingFees extends StatefulWidget {
  subServiceArrangingFees({@required controller}) {
    tabController = controller;
  }
  @override
...
class _DynamicTableState extends State<subServiceArrangingFees> {
  ...
  void fundAdvisoryFees() async {
    ...
    var url = Uri.parse(
        'http://8.213.23.26:8081/apicore/api/AdvisoryFeesDetail/AdvisoryFeesModel');
    ...
    try {
      ...
      var body = {
        "advisoryId": subServiceArrangingFees.id.value,
        "fees": feesList,
      };
