...
import 'package:east_bridge/Arranging/SubServiceCreation/subServiceCreationArr.dart';
import 'package:east_bridge/Arranging/SubServiceCreation/subServiceFeesArr.dart';
...
class TabOfArrangings extends StatelessWidget {
  const TabOfArrangings({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return ResponsiveLayout(
      largeScreen: tabOfSubServiceCreactionArranging(),
      //mediumScreen: MediumChild(),
      smallScreen: TabOfArrangingsMob(),
    );
  }
}

//webKYC
class tabOfSubServiceCreactionArranging extends StatefulWidget {
  const tabOfSubServiceCreactionArranging({Key? key}) : super(key: key);

  @override
  State<tabOfSubServiceCreactionArranging> createState() => tabOfSubServiceCreactionArrangingState();
}

class tabOfSubServiceCreactionArrangingState extends State<tabOfSubServiceCreactionArranging>
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  Center(
                                      child: Text(
                                    S.of(context).ArrangingCreation,
                                      ...
                                      child: Center(
                                        child: TabBar(
                                          ...
                                          tabs: [
                                            ...
                                            Tab(
                                                child: Text(
                                              S.of(context).ArrangingFeesDetails,
                                              style:
                              ...
                              Expanded(
                                child: TabBarView(
                                  ...
                                  children: [
                                    ...
                                    subServiceCreationArranging(
                                      controller: tabController,
                                    ),
                                    subServiceArrangingFees(
                                      controller: tabController,
                                    ),
                                  ],
                                ),
...
//MobKYC
class TabOfArrangingsMob extends StatefulWidget {
  const TabOfArrangingsMob({Key? key}) : super(key: key);

  @override
  State<TabOfArrangingsMob> createState() => _TabOfArrangingsMobState();
}

class _TabOfArrangingsMobState extends State<TabOfArrangingsMob> {
  @override
  Widget build(BuildContext context) {
