...
class ArrangingBankDetails extends StatefulWidget {
  ArrangingBankDetails({@required controller}) {
    tabController = controller;
  }

  @override
  State<ArrangingBankDetails> createState() => _ArrangingBankDetailsState();
  static ValueNotifier<int> id = new ValueNotifier(0);
}

TabController? tabController;

class _ArrangingBankDetailsState extends State<ArrangingBankDetails> {
  ...
  Widget build(BuildContext context) {
    void Fundbank() async {
      var url = Uri.parse(
          'http://8.213.23.26:8081/apicore/api/ArrangingBankDetail/ArrangingBankDetail');
      ...
      try {
        ...
        var body = {
          "ArrangingId": ArrangingBankDetails.id.value,
