...
class ArrangingAgreementSearchs extends StatefulWidget {
  const ArrangingAgreementSearchs({super.key, TabController? controller});

  @override
  State<ArrangingAgreementSearchs> createState() =>
      _ArrangingAgreementSearchsState();
}

class _ArrangingAgreementSearchsState extends State<ArrangingAgreementSearchs> {
  List title = [];
                ...
                children: [
                  Row(
                    ...
                    children: [
                      Center(
                        child: Text(
                          S.of(context).ArrangingAgreementTemplateSearch,
