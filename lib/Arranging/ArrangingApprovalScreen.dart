...
class TabOfArranging extends StatelessWidget {
  const TabOfArranging({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return ResponsiveLayout(
      largeScreen: ArrangingApprovalRequest(),
      //mediumScreen: MediumChild(),
      smallScreen: TabOfArrangingMob(),
    );
  }
}

//webKYC
class ArrangingApprovalRequest extends StatefulWidget {
  const ArrangingApprovalRequest({Key? key}) : super(key: key);

  @override
  State<ArrangingApprovalRequest> createState() =>
      ArrangingApprovalRequestState();
}

class ArrangingApprovalRequestState extends State<ArrangingApprovalRequest>
...
//MobKYC
class TabOfArrangingMob extends StatefulWidget {
  const TabOfArrangingMob({Key? key}) : super(key: key);

  @override
  State<TabOfArrangingMob> createState() => _TabOfArrangingMobState();
}

class _TabOfArrangingMobState extends State<TabOfArrangingMob> {
  @override
  Widget build(BuildContext context) {
