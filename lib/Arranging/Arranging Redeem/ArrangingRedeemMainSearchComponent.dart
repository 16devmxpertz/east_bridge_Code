...
class ArrangingRedeemMainSearchComponent extends StatefulWidget {
  const ArrangingRedeemMainSearchComponent({super.key});

  @override
  State<ArrangingRedeemMainSearchComponent> createState() =>
      _ArrangingRedeemMainSearchComponentsStat();
}

class _ArrangingRedeemMainSearchComponentsStat
    extends State<ArrangingRedeemMainSearchComponent> {
                          ...
                          return GestureDetector(
                              onTap: () {
                                ...
                                Navigator.of(context).push(MaterialPageRoute(
                                    builder: (context) => new AdvisoryRedeems()));
                                setState(
                                  () {
                                    isCustomerSearch = false;
                                  },
