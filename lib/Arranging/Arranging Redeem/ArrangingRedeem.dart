...
import 'package:east_bridge/Arranging/Arranging%20Redeem/ArrangingRedeemMainSearchComponent.dart';
...
class ArrangingRedeems extends StatefulWidget {
  const ArrangingRedeems({super.key});

  @override
  State<ArrangingRedeems> createState() => _ArrangingRedeemsState();
...
class _ArrangingRedeemsState extends State<ArrangingRedeems> {
  ...
  int currentValue = 0;
  // String value = "";
  //int pershare = int.parse(ArrangingSubscribe.persharevalue.value);
  ...
  void initState() {
    super.initState();
    NoOfShares.text = "0";
    print(ArrangingRedeems.name.value);
    //_calculation();

    setState(() {
      clientName.text = ArrangingRedeems.name.value;
      fundName.text = ArrangingRedeems.fundname.value;
      PerShareValue.text = ArrangingRedeems.persharevalue.value;
  ...
  _launchURLApp() async {
    var url = Uri.parse(
        "http://localhost/ReportServer/Pages/ReportViewer.aspx?%2fEastBridgeReport%2finvoice&rs:Command=Render&rs:ClearSession=True&rs:Format=PDF&rs:FileExtension=Subscribe.PDF&FID=${ArrangingRedeems.fundid.value}&CID=${ArrangingRedeems.clientid.value}");
  ...
  void sendData() async {
    var url = Uri.parse(
        'http://8.213.23.26:8081/apicore/api/ArrangingRedeemsRedeem/ArrangingRedeemsRedeem/');
    ...
    try {
      ...
      var body = {
        "clientId": ArrangingRedeems.clientid.value,
        "fundId": ArrangingRedeems.fundid.value,
        "fundName": fundName.text,
        "type": "Subscribe",
        "date": date.text,
        "perShareValue": int.parse(ArrangingRedeems.persharevalue.value),
  ...
  void search() async {
    var url = Uri.parse(
        'http://8.213.23.26:8081/apicore/api/Search?searchValue=${fundName.text}');
                                      ...
                                      child: SingleChildScrollView(
                                        child: Column(
                                          children: [
                                            ...
                                            ArrangingRedeemMainSearchComponent(),
                                            Container(
                                              margin: EdgeInsets.symmetric(
                                                horizontal: 10,
                                              ),
                                                      ...
                                                      children: [
                                                        ...
                                                        Flexible(
                                                          child: Container(
                                                            ...
                                                            child:
                                                                TextFormField(
                                                              //   initialValue: ArrangingSubscribe.name.value,
                                                              controller:
                                                                  clientName,
                                                              readOnly: true,
                                                              textAlignVertical:
