...
class PortfolioManagerSearch extends StatefulWidget {
  const PortfolioManagerSearch({super.key});

  @override
  State<PortfolioManagerSearch> createState() => _PortfolioManagerSearchStat();
}

class _PortfolioManagerSearchStat extends State<PortfolioManagerSearch> {
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          return GestureDetector(
                              onTap: () {
                                ...
                                AssignPortfolioManager.name.value = li[index];
                                AssignPortfolioManager.clientid.value =
                                    int.parse(key[index]);
                                Navigator.of(context).push(MaterialPageRoute(
                                    builder: (context) =>
                                        new AssignPortfolioManager()));
                                setState(
                                  () {
                                    isCustomerSearch = false;
                                  },
