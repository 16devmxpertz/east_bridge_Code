...
class DPMAgreementCustomerSearch extends StatefulWidget {
  const DPMAgreementCustomerSearch({super.key, TabController? controller});

  @override
  State<DPMAgreementCustomerSearch> createState() =>
      DPMAgreementCustomerSearchState();
}

class DPMAgreementCustomerSearchState
    extends State<DPMAgreementCustomerSearch> {
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          return GestureDetector(
                              onTap: () {
                                ...
                                DPMPdfDownloadUpload.id.value =
                                    int.parse(key[index]);
                                DPMPdfDownloadUpload.clientName.value =
                                    li[index];
                                Navigator.of(context).push(MaterialPageRoute(
                                    builder: (context) =>
                                        new DPMPdfDownloadUpload()));
                                setState(
                                  () {
                                    isCustomerSearch = false;
                                  },
