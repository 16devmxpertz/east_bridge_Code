...
class DPMPortfolioCreationSearchComponent extends StatefulWidget {
  const DPMPortfolioCreationSearchComponent({super.key});

  @override
  State<DPMPortfolioCreationSearchComponent> createState() =>
      _DPMSellMainSearchComponentStat();
}

class _DPMSellMainSearchComponentStat
    extends State<DPMPortfolioCreationSearchComponent> {
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            return GestureDetector(
                                onTap: () {
                                  ...
                                  PortfolioCreation.name.value = li[index];
                                  PortfolioCreation.id.value =
                                      int.parse(key[index]);
                                  Navigator.of(context).push(MaterialPageRoute(
                                      builder: (context) =>
                                          new TabOfPortfolioCreationDPM()));
                                  setState(
                                    () {
                                      isCustomerSearch = false;
                                    },
