...
class IndividualKYC extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ResponsiveLayout(
      largeScreen: TabOfPortfolioCreationDPM(),
...
//webKYC
class TabOfPortfolioCreationDPM extends StatefulWidget {
  const TabOfPortfolioCreationDPM({Key? key}) : super(key: key);

  @override
  State<TabOfPortfolioCreationDPM> createState() => TabOfPortfolioCreationDPMState();
}

class TabOfPortfolioCreationDPMState extends State<TabOfPortfolioCreationDPM>
