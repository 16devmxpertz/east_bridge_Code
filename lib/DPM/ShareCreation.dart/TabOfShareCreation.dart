...
class IndividualKYC extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ResponsiveLayout(
      largeScreen: TabOfShareCreation(),
...
//webKYC
class TabOfShareCreation extends StatefulWidget {
  const TabOfShareCreation({Key? key}) : super(key: key);

  @override
  State<TabOfShareCreation> createState() => TabOfFundCreationState();
}

class TabOfFundCreationState extends State<TabOfShareCreation>
