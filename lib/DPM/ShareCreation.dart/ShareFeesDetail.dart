...
class ShareFeesDetail extends StatefulWidget {
  ShareFeesDetail({@required controller}) {
...
class _DynamicTableState extends State<ShareFeesDetail> {
  ...
  void fundAdvisoryFees() async {
    var url = Uri.parse(
        '${GlobalPermission.urlLink}/api/DPMShareFeesDetail/DPMShareFeesDetail');
    ...
    if (response.statusCode == 200) {
      ...
      GlobalPermissionDPM.getdraftprogressfund(GlobalPermissionDPM.DPMid);
      print(GlobalPermissionDPM.DPMid);
      GlobalPermissionDPM.DPMid = 0;
      GlobalPermissionDPM.DPMdraftprogress = {};
  ...
  void PutData(int Id) async {
    var url = Uri.parse(
        '${GlobalPermission.urlLink}/api/DPMShareFeesDetail/DPMShareFeesDetailUpdate');
    ...
    try {
      ...
      var body = {
        "fundId": GlobalPermissionDPM.DPMid,
        "fees": feesListfinal,
      };
  ...
  Future<void> fetchData(int Id) async {
    var url = Uri.parse(
        '${GlobalPermission.urlLink}/api/DPMShareFeesDetail/DPMShareFeesDetail/${GlobalPermissionDPM.DPMid}'); // Replace with your API endpoint
  ...
  void initState() {
    ...
    if (GlobalPermissionDPM.DPMdraftprogress["DPMShareFeesDetail"] == true) {
      print("ftechinggg----------");
                      ...
                      if (_formKey.currentState!.validate()) {
                        if (FeesList.isNotEmpty) {
                          ...
                          if (GlobalPermissionDPM
                                  .DPMdraftprogress["DPMShareFeesDetail"] ==
                              true) {
                            ...
                            if (GlobalPermissionDPM.DPMid != 0) {
                              ...
                              Fluttertoast.showToast(
                                  msg: "Please fill Product Detail  first",
                                  toastLength: Toast.LENGTH_SHORT,
                                  gravity: ToastGravity.CENTER,
                                  timeInSecForIosWeb: 3,
                                  backgroundColor: Colors.red,
