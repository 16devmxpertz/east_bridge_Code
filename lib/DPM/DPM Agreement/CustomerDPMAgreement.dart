...
//webKYC
class CustomerDPMAgreement extends StatefulWidget {
  CustomerDPMAgreement({Key? key}) : super(key: key);

  @override
  State<CustomerDPMAgreement> createState() => _CustomerDPMAgreementState();
}

class _CustomerDPMAgreementState extends State<CustomerDPMAgreement>
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    Center(
                                        child: Text(
                                      S.of(context).CustomerDPMAgreement,
