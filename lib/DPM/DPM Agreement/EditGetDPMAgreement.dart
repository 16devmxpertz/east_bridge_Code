...
class EditDPMGetAgreement extends StatefulWidget {
  EditDPMGetAgreement(@required String x) {
    Id = int.parse(x);
  }

  @override
  _EditDPMGetAgreementState createState() => _EditDPMGetAgreementState();
...
class _EditDPMGetAgreementState extends State<EditDPMGetAgreement> {
  ...
  void customerData() async {
    ...
    final response = await http.get(Uri.parse(
        'https://eastbridge.online/apicore/api/GetClientDataForAgreement?id=${EditDPMGetAgreement.clientId.value}'));
