...
import 'package:east_bridge/DPM/DPM%20Agreement/d2.dart';
...
class EditDPMAgreementSearch extends StatefulWidget {
  EditDPMAgreementSearch({super.key, TabController? controller});

  @override
  State<EditDPMAgreementSearch> createState() => _EditDPMAgreementSearchState();
  static ValueNotifier<int> id = new ValueNotifier(0);
}

class _EditDPMAgreementSearchState extends State<EditDPMAgreementSearch> {
  List title = [];
  ...
  void fetchData() async {
    ...
    print("Shah1");
    print(EditDPMAgreementSearch.id.value);
