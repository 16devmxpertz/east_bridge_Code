...
class ProductSelectDPM extends StatefulWidget {
  ProductSelectDPM({super.key, TabController? controller});

  @override
  State<ProductSelectDPM> createState() => _CustomerDPMAgreementSearchState();
  static ValueNotifier<int> id = new ValueNotifier(0);
}

class _CustomerDPMAgreementSearchState extends State<ProductSelectDPM> {
  List title = [];
  ...
  void fetchData() async {
    ...
    print("Shah1");
    print(ProductSelectDPM.id.value);
