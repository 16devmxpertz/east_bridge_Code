...
class DPMSellMainSearchComponent extends StatefulWidget {
  const DPMSellMainSearchComponent({super.key});

  @override
  State<DPMSellMainSearchComponent> createState() =>
      _DPMSellMainSearchComponentStat();
}

class _DPMSellMainSearchComponentStat
    extends State<DPMSellMainSearchComponent> {
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            return GestureDetector(
                                onTap: () {
                                  ...
                                  DPMSell.name.value = li[index];
                                  DPMSell.clientid.value =
                                      int.parse(key[index]);
                                  Navigator.of(context).push(MaterialPageRoute(
                                      builder: (context) => new DPMSell()));
                                  setState(
                                    () {
                                      isCustomerSearch = false;
                                    },
