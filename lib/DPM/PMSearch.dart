...
class PMSearch extends StatefulWidget {
  PMSearch({super.key, TabController? controller});

  @override
  State<PMSearch> createState() => _PMSearchState();
  static ValueNotifier<int> id = new ValueNotifier(0);
}

class _PMSearchState extends State<PMSearch> {
  List title = [];
              ...
              child: ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  return GestureDetector(
                      onTap: () {
                        AssignPortfolioManager.portname.value = li[index];
                        AssignPortfolioManager.pmid.value =
                            int.parse(key[index]);
