...
class CustomerSearchRiskIndividual extends StatefulWidget {
  const CustomerSearchRiskIndividual({super.key});

  @override
  State<CustomerSearchRiskIndividual> createState() =>
      _CustomerSearchRiskIndividualStat();
}

class _CustomerSearchRiskIndividualStat
    extends State<CustomerSearchRiskIndividual> {
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return GestureDetector(
                            onTap: () {
                              RiskForm.clientID.value = int.parse(key[index]);
                              RiskForm.clientName.value = li[index];
                              RiskForm.send.value = false;
                              Navigator.of(context).push(MaterialPageRoute(
                                  builder: (context) => new RiskForm()));
                            },
