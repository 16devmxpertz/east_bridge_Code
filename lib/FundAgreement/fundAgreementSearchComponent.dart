...
class FundAgreementSearchComponent extends StatefulWidget {
  FundAgreementSearchComponent({@required controller}) {
    tabController = controller;
  }

  @override
  State<FundAgreementSearchComponent> createState() =>
      _FundAgreementSearchComponentStat();
...
class _FundAgreementSearchComponentStat
    extends State<FundAgreementSearchComponent> {
                ...
                return GestureDetector(
                    onTap: () {
                      ClientFundAgreementSearch.id.value =
                          int.parse(key[index]);
                      FundAgreementSearchComponent.clientName.value = li[index];
          ...
          Container(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                return GestureDetector(
                    onTap: () {
                      FundAgreementSearchComponent.fundName.value =
                          fli[index].split("~")[0];
                      CustomerFundAgreementDoc.fundid.value =
                ...
                Container(
                  child: Row(
                    children: [
                      ...
                      Text(
                        FundAgreementSearchComponent.clientName.value,
                        style: TextController.BodyText,
                      ),
                    ],
                  ),
