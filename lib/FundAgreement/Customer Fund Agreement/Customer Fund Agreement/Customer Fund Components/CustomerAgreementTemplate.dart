...
class CustomerAgreementTemplate extends StatefulWidget {
  CustomerAgreementTemplate({@required controller}) {
    tabController = controller;
  }
  @override
  CustomerAgreementTemplateState createState() =>
      CustomerAgreementTemplateState();
}

TabController? tabController;

class CustomerAgreementTemplateState extends State<CustomerAgreementTemplate> {
  ...
  void senddata() async {
    ...
    final response = await http.post(
      Uri.parse(
          'http://8.213.23.26:8081/apicore/api/TandCDynamic/TandCDynamic'),
      headers: headers,
