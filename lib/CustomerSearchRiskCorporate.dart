...
class CustomerSearchRiskCorporate extends StatefulWidget {
  const CustomerSearchRiskCorporate({super.key});

  @override
  State<CustomerSearchRiskCorporate> createState() =>
      _CustomerSearchRiskCorporateStat();
}

class _CustomerSearchRiskCorporateStat
    extends State<CustomerSearchRiskCorporate> {
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return GestureDetector(
                            onTap: () {
                              RiskFormCorporate.clientID.value =
                                  int.parse(key[index]);
                              RiskFormCorporate.clientName.value = li[index];
                              RiskFormCorporate.send.value = false;
                              Navigator.of(context).push(
                                MaterialPageRoute(
                                  builder: (context) => new RiskFormCorporate(),
                                ),
                              );
                            },
