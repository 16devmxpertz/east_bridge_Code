import 'package:east_bridge/Customer%20Agreement%20Have%20to%20Remove/ClientSelection.dart';
...
class FundSelecion extends StatefulWidget {
  @override
  State<FundSelecion> createState() => _FundSelecionState();
}

class _FundSelecionState extends State<FundSelecion> {
  double yOffset = 0;
  double xOffset = 0;
