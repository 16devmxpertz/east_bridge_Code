...
class ReportsSearch extends StatefulWidget {
  ...
  @override
  State<ReportsSearch> createState() => _ReportsSearchsStat();
  static ValueNotifier<String> type = new ValueNotifier("");
}

class _ReportsSearchsStat extends State<ReportsSearch> {
            ...
            Container(
              decoration: BoxDecoration(
                border: Border(
                  ...
                  bottom:
                      BorderSide(width: 1, color: ColorSelect.tabBorderColor),
                ),
              ),
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          return GestureDetector(
                              onTap: () {
                                ...
                                ReportsDownload.name.value = li[index];
                                ReportsDownload.clientid.value =
                                    int.parse(key[index]);
                                Navigator.of(context).push(MaterialPageRoute(
                                    builder: (context) => new ReportsDownload(
                                          type: ReportsSearch.type.value,
                                        )));
                                setState(
                                  () {
                                    isCustomerSearch = false;
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          return GestureDetector(
                              onTap: () {
                                ...
                                print(split);
                                ReportsDownload.fundname.value = split[0];

                                ReportsDownload.fundid.value =
