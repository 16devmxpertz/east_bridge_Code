...
class InvestmentPortfolioB extends StatefulWidget {
  InvestmentPortfolioB({@required controller}) {
    tabController = controller;
  }

  @override
  State<InvestmentPortfolioB> createState() => _InvestmentPortfolioBState();
...
class _InvestmentPortfolioBState extends State<InvestmentPortfolioB> {
  String btn = "Next";
  // InvestmentPortfolioB({controller}) {
  //   tabController = controller;
  // }
  ...
  void initState() {
    super.initState();
    // getdata(9043);
    ClientName.text = InvestmentPortfolioB.clientName.value;

    print("Init Runnng");
    if (GlobalIndividual.individualdraftprogress["InvestmentProfileB"] ==
        true) {
      print("ftechinggg----------");
  ...
  Future getdata(int clientId) async {
    print("getting");
    var url = Uri.parse(
        '${GlobalPermission.urlLink}/api/InvestmentProfileB/${clientId}');
  ...
  void senddata() async {
    ...
    var url = Uri.parse(
        '${GlobalPermission.urlLink}/api/InvestmentProfileB/InvesmentProfileB/');
  ...
  void putdata(int clientId) async {
    ...
    var url = Uri.parse(
        '${GlobalPermission.urlLink}/api/InvestmentProfileB/InvestmentProfileB?ClientId=${clientId}');
