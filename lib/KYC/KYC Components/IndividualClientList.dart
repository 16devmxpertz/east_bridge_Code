...
class IndividualClientList extends StatefulWidget {
  const IndividualClientList({super.key});

  @override
  State<IndividualClientList> createState() => _IndividualClientListState();
...
class _IndividualClientListState extends State<IndividualClientList> {
  double yOffset = 0;
  double xOffset = 0;
  ...
  void getclientlist() async {
    var url = Uri.parse(
        '${GlobalPermission.urlLink}/api/GetAllClients/GetAllClientsOfIndividual/');
                        ...
                        MouseRegion(
                          ...
                          child: InkWell(
                            onTap: () async {
                              ...
                              await GlobalIndividual.getdraftprogressindividual(
                                  int.parse(templateKeys));
                              // ANBAccountIndividual.name.value =
                              //     li[index];
                              Navigator.of(context).push(MaterialPageRoute(
                                  builder: (context) => new newInd("")));
                            },
                            child: Icon(
                              Icons.edit,
                              color: ColorSelect.east_blue,
