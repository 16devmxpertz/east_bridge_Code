...
class EmployerInfo extends StatefulWidget {
  EmployerInfo({@required controller}) {
...
class _EmployerInfoState extends State<EmployerInfo>
  ...
  void initState() {
    ...
    print("Init Runnng");
    if (GlobalIndividual.individualdraftprogress["EmployerInformation"] ==
        true) {
      print("ftechinggg----------");
  ...
  Future getdata(int clientId) async {
    print("getting");
    var url = Uri.parse(
        '${GlobalPermission.urlLink}/api/EmployerInformation1/${clientId}');
  ...
  void senddata() async {
    ...
    var url = Uri.parse(
        '${GlobalPermission.urlLink}/api/EmployerInformation1/EmployerInformation/');
  ...
  void putdata(int clientId) async {
    ...
    var url = Uri.parse(
        '${GlobalPermission.urlLink}/api/EmployerInformation1/EmployerInformation?ClientId=${clientId}');
