...
class PostalAddress extends StatefulWidget {
  ...
  @override
  State<PostalAddress> createState() => _PostalAddressState();
...
class _PostalAddressState extends State<PostalAddress> {
  ...
  // PostalAddress({@required controller}) {
  //   tabController = controller;
  // }
  ...
  Future getdata(int clientId) async {
    print("getting");
    var url = Uri.parse(
        '${GlobalPermission.urlLink}/api/PostalAddress/postaladdress/${clientId}');
  ...
  void initState() {
    ...
    if (GlobalIndividual.individualdraftprogress["PostalAddress"] == true) {
      print("ftechinggg----------");
  ...
  void senddata() async {
    ...
    print(countrycode);
    var url = Uri.parse(
        '${GlobalPermission.urlLink}/api/PostalAddress/postaladdress/');
