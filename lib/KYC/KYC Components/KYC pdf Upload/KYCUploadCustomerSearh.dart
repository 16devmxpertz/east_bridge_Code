...
class KYCUploadCustomerSearch extends StatefulWidget {
  const KYCUploadCustomerSearch({super.key, TabController? controller});

  @override
  State<KYCUploadCustomerSearch> createState() =>
      _KYCUploadCustomerSearchStat();
}

class _KYCUploadCustomerSearchStat extends State<KYCUploadCustomerSearch> {
                ...
                itemBuilder: (BuildContext context, int index) {
                  return GestureDetector(
                      onTap: () {
                        ...
                        KYCPdfUploadIND.name.value = li[index];
                        KYCPdfUploadIND.id.value = int.parse(key[index]);

                        Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) => new KYCPdfUploadIND()));
                      },
