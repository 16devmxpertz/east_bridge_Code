...
class _CC2State extends State<CC2> {
  ...
  void initState() {
    ...
    print("Init Runnng");
    if (GlobalIndividual
            .individualdraftprogress["ClientClassificationIndividual"] ==
        true) {
      print("ftechinggg----------");
...
/////
  ...
  void senddata() async {
    ...
    var response = await dio.post(
      "${GlobalPermission.urlLink}/api/ClientClassificationIndividual/ClientClassificationIndividual/",
      data: data,
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: () {
                                if (ClientType == "") {
                                  ...
                                  //         "ClientClassificationIndividual"] ==
                                  //     true) {
                                  //   putdata(
                                  //       GlobalIndividual.individualclientid);
                                  // } else {
