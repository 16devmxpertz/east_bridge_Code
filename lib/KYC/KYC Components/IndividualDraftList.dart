...
class IndividualDraftList extends StatefulWidget {
  const IndividualDraftList({super.key});

  @override
  State<IndividualDraftList> createState() => _IndividualDraftListState();
...
class _IndividualDraftListState extends State<IndividualDraftList> {
  double yOffset = 0;
  double xOffset = 0;
  ...
  void getindDraftList() async {
    var url = Uri.parse(
        '${GlobalPermission.urlLink}/api/GetCutomersFromDraft/GetCustomersOfDraftOfIndividual/');
                                          ...
                                          return GestureDetector(
                                              onTap: () async {
                                                GlobalIndividual
                                                        .individualclientid =
                                                    int.parse(key[index]);
                                                await GlobalIndividual
                                                    .getdraftprogressindividual(
                                                        int.parse(key[index]));
