...
class POADraftList extends StatefulWidget {
  const POADraftList({super.key});

  @override
  State<POADraftList> createState() => _POADraftListState();
...
class _POADraftListState extends State<POADraftList> {
  double yOffset = 0;
  double xOffset = 0;
  ...
  void getpoaDraftList() async {
    var url = Uri.parse(
        '${GlobalPermission.urlLink}/api/GetCutomersFromDraft/GetCustomersOfDraftOfPOA/');
