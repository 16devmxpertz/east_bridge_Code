...
class ProfessionalExpPOA extends StatefulWidget {
  ProfessionalExpPOA({@required controller}) {
    tabController = controller;
  }

  @override
  State<ProfessionalExpPOA> createState() => _ProfessionalExpPOAState();
  static ValueNotifier<int> id = ValueNotifier(0);
}

TabController? tabController;

class _ProfessionalExpPOAState extends State<ProfessionalExpPOA> {
  String btn = "Next";
  // ProfessionalExpPOA({@required controller}) {
  //   tabController = controller;
  // }
  ...
  void initState() {
    ...
    print("Init Runnng");
    if (GlobalPOA.poadraftprogress["ProfessionalExperiencePOA"] == true) {
      print("ftechinggg----------");
  ...
  Future getdata(int clientId) async {
    print("getting");
    var url = Uri.parse(
        '${GlobalPermission.urlLink}/api/ProfessionalExperienceControllerPOA/ProfessionalExperienceControllerPOA/${clientId}');
    ...
    if (response.statusCode == 200) {
      ...
      _text1.text = data["professionalExp1"];
  ...
  void senddata() async {
    ...
    var url = Uri.parse(
        '${GlobalPermission.urlLink}/api/ProfessionalExperienceControllerPOA/ProfessionalExperienceControllerPOA/');
    ...
    try {
      ...
      var body = {
        ...
        "ProfessionalExp1": _text1.text == "" ? "No" : _text1.text,
  ...
  void putdata(int clientId) async {
    ...
    var url = Uri.parse(
        '${GlobalPermission.urlLink}/api/ProfessionalExperienceControllerPOA/ProfessionalExperienceControllerPOAPut?ClientId=${clientId}');
