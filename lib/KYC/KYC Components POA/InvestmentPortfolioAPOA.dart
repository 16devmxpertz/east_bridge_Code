...
class InvestmentPortfolioAPOA extends StatefulWidget {
  InvestmentPortfolioAPOA({@required controller}) {
    tabController = controller;
  }

  @override
  State<InvestmentPortfolioAPOA> createState() =>
      _InvestmentPortfolioAPOAState();
  static ValueNotifier<int> id = ValueNotifier(0);
}

TabController? tabController;

class _InvestmentPortfolioAPOAState extends State<InvestmentPortfolioAPOA> {
  String btn = "Next";
  ...
  void initState() {
    ...
    print("Init Runnng");
    if (GlobalPOA.poadraftprogress["InvestmentProfileAPOA"] == true) {
      print("ftechinggg----------");
  ...
  Future getdata(int clientId) async {
    print("getting");
    var url = Uri.parse(
        '${GlobalPermission.urlLink}/api/InvestmentProfileAPOA/InvestmentProfileA/${clientId}');
  ...
  void senddata() async {
    ...
    var url = Uri.parse(
        '${GlobalPermission.urlLink}/api/InvestmentProfileAPOA/InvestmentProfileA/');
  ...
  void putdata(int clientId) async {
    ...
    var url = Uri.parse(
        '${GlobalPermission.urlLink}/api/InvestmentProfileAPOA/InvestmentProfileA?ClientId=${clientId}');
