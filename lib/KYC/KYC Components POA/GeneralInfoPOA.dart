...
class GeneralInfoPOA extends StatefulWidget {
  GeneralInfoPOA({@required controller}) {
    tabController = controller;
  }
  @override
  State<GeneralInfoPOA> createState() => _GeneralInfoPOAState();
  static ValueNotifier<int> id = ValueNotifier(0);
}

TabController? tabController;

class _GeneralInfoPOAState extends State<GeneralInfoPOA> {
  String btn = "Next";
  ...
  void initState() {
    ...
    print("Init Runnng");
    if (GlobalPOA.poadraftprogress["GenralInformationPOA"] == true) {
      print("ftechinggg----------");
  ...
  Future getdata(int clientId) async {
    print("getting");
    var url = Uri.parse(
        '${GlobalPermission.urlLink}/api/GenralInformationPOA/GenralInformationPOA/${clientId}');
  ...
  void senddata() async {
    ...
    var url = Uri.parse(
        '${GlobalPermission.urlLink}/api/GenralInformationPOA/GenralInformationPOA/');
