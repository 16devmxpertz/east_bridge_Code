...
class POAClientList extends StatefulWidget {
  const POAClientList({super.key});

  @override
  State<POAClientList> createState() => _POAClientListState();
...
class _POAClientListState extends State<POAClientList> {
  double yOffset = 0;
  double xOffset = 0;
  ...
  void getclientlist() async {
    var url = Uri.parse(
        '${GlobalPermission.urlLink}/api/GetAllClients/GetAllClientsOfPOA/');
  ...
  Widget table(String templateName, int index, String templateKeys,
                    ...
                    Row(
                      ...
                      children: [
                        MouseRegion(
                          ...
                          child: InkWell(
                            onTap: () async {
                              GlobalPOA.poalclientid = int.parse(templateKeys);
                              await GlobalPOA.getdraftprogresspoa(
                                  int.parse(templateKeys));
                              // ANBAccountIndividual.name.value =
                              //     li[index];
                              Navigator.of(context).push(MaterialPageRoute(
                                  builder: (context) => new POAKYC("")));
                            },
                            child: Icon(
                              Icons.edit,
                              color: ColorSelect.east_blue,
