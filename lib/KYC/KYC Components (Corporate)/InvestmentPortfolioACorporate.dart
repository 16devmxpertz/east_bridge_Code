...
class _InvestmentPortfolioAState extends State<InvestmentPortfolioACorporate> {
  ...
  TextEditingController _profileRealEstatesCurrent =
      new TextEditingController();
  ...
  void InvestmentProfileA() async {
    ...
    var body = {
      ...
      "profileDepositeandMurabhaCurrent": currentdeposit.text,
      "profileDepositeandMurabhaIdeal": idealdeposit.text,
      "profileDebutInstrumentCurrent": currentdebt.text,
      "profileDebutInstrumentIdeal": idealdebt.text,
      "profileSharesCurrent": currentshare.text,
      "profileSharesIdeal": idealshare.text,
      "profileRealEstatesCurrent": currentreal.text,
      "profileRealEstatesIdeal": idealreal.text,
      "profileDerivativeContractsCurrent": currentderivative.text,
      "profileDerivativeContractsIdeal": idealderivative.text,
      "profileAlternativeInvestmentsCurrent": currentalternative.text,
      "profileAlternativeInvestmentsIdeal": idealalternative.text,
      "cikE1": _cikE1.text,
      "cikE2": _cikE2.text,
      "cikE3": _cikE3.text,
      "cikE4": _cikE4.text,
    ...
    final response = await http.post(
        Uri.parse(
            '${GlobalPermission.urlLink}/api/InvestmentProfileACorporate'),
        headers: headers,
  ...
  void PutData(int Id) async {
    ...
    final response = await http.put(
        Uri.parse(
            '${GlobalPermission.urlLink}/api/InvestmentProfileACorporate/$Id'),
        headers: headers,
        body: jsonEncode(body));
  ...
  Future<void> fetchData(int id) async {
    print("fetchingg");
    var url =
        '${GlobalPermission.urlLink}/api/InvestmentProfileACorporate/${id}'; // Replace with your API endpoint
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          currentdeposit.text =
              jsonResponse["profileDepositeandMurabhaCurrent"];
          idealdeposit.text = jsonResponse["profileDepositeandMurabhaIdeal"];
          currentdebt.text = jsonResponse["profileDebutInstrumentCurrent"];
          idealdebt.text = jsonResponse["profileDebutInstrumentIdeal"];
          currentshare.text = jsonResponse["profileSharesCurrent"];
          idealshare.text = jsonResponse["profileSharesCurrent"];
          currentreal.text = jsonResponse["profileRealEstatesCurrent"];
          idealreal.text = jsonResponse["profileRealEstatesIdeal"];

          currentderivative.text =
              jsonResponse["profileDerivativeContractsCurrent"];

          idealderivative.text =
              jsonResponse["profileDerivativeContractsIdeal"];

          currentalternative.text =
              jsonResponse["profileAlternativeInvestmentsCurrent"];

          idealalternative.text =
              jsonResponse["profileAlternativeInvestmentsIdeal"];
          _cikE1.text = jsonResponse["cikE1"];
          _cikE2.text = jsonResponse["cikE2"];
          _cikE3.text = jsonResponse["cikE3"];
          _cikE4.text = jsonResponse["cikE4"];
          _cikE5.text = jsonResponse["cikE5"];
          _cikE6.text = jsonResponse["cikE6"];
          _cikE7.text = jsonResponse["cikE7"];
          selectedValue =
              jsonResponse["cikeClientInvestmentKnowledgeExperience"];
          selectedValue2 = jsonResponse["clientAppetiteRisk"];
        });
  ...
  void initState() {
    ...
    if (GlobalPermissionCorporate
            .corporatedraftprogress["InvestmentProfileACorporate"] ==
        true) {
      print("ftechinggg----------");
