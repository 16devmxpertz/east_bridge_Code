      ...
      body: Padding(
        ...
        child: Column(
          ...
          if(isCountrySelected)
            Card(
               color: Color.fromARGB(255, 244, 242, 245).withOpacity(0.5),
            shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8)),
              child: Container(
            ...
            if(isStateSelected)
            Card(
              color: Color.fromARGB(255, 253, 249, 253).withOpacity(0.5),
            shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8)),
              child: Container(
            ...
            ElevatedButton(onPressed: () {
                     Navigator.push(
                    context,
           MaterialPageRoute(builder: (context) =>  CorporateKYC("")),
                   );
            }, child: Text("Press me"))
