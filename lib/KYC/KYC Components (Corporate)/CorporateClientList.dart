...
import 'CorporatedraftList.dart';

class CorporateClientList extends StatefulWidget {
  const CorporateClientList({super.key});

  @override
  State<CorporateClientList> createState() => _IndividualClientListState();
...
class _IndividualClientListState extends State<CorporateClientList> {
  double yOffset = 0;
  double xOffset = 0;
  ...
  void getclientlist() async {
    var url = Uri.parse(
        '${GlobalPermission.urlLink}/api/GetAllClients/GetClientsOfCorportate');
                          ...
                          child: InkWell(
                            onTap: () async {
                              ...
                              Navigator.of(context).push(MaterialPageRoute(
                                  builder: (context) => new CorporateKYC("")));
                            },
                            child: Icon(
                              Icons.edit,
                              color: ColorSelect.east_blue,
