...
class FundSubscribeMainSearchComponent extends StatefulWidget {
  const FundSubscribeMainSearchComponent({super.key});

  @override
  State<FundSubscribeMainSearchComponent> createState() =>
      _FundSubscribeMainSearchComponentsStat();
}

class _FundSubscribeMainSearchComponentsStat
    extends State<FundSubscribeMainSearchComponent> {
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          return GestureDetector(
                              onTap: () {
                                ...
                                FundSubscribe.name.value = li[index];
                                FundSubscribe.clientid.value =
                                    int.parse(key[index]);
