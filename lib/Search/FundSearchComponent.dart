...
class FundSearchComponent extends StatefulWidget {
  const FundSearchComponent({super.key});

  @override
  State<FundSearchComponent> createState() => _FundSearchComponentsStat();
}

class _FundSearchComponentsStat extends State<FundSearchComponent> {
