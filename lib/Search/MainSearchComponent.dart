...
class MainSearchComponent extends StatefulWidget {
  const MainSearchComponent({super.key});

  @override
  State<MainSearchComponent> createState() => _MainSearchComponentsStat();
}

class _MainSearchComponentsStat extends State<MainSearchComponent> {
