...
import 'dart:convert';
import '../FundAgreement/Customer Fund Agreement/Customer Fund Agreement/CustomerFundAgreement.dart';
import 'CustomerGetAgreement.dart';
...
class FundAgreementFinal extends StatefulWidget {
  FundAgreementFinal({@required controller}) {
    tabController = controller;
  }
  @override
  FundAgreementFinalState createState() => FundAgreementFinalState();
  static ValueNotifier<int> id = new ValueNotifier(0);
}
TabController? tabController;


class FundAgreementFinalState extends State<FundAgreementFinal> {
  ...
  void loadTodoItemsarabic() async {
    ...
    final response = await http.get(
      Uri.parse(
          'https://eastbridge.online/apicore/api/TandCDynamic/DefaultTandCGet'),
      headers: headers,
    );
  ...
  void senddata() async {
    ...
    FormData data = FormData.fromMap({
      "fundId": FundAgreementFinal.id.value,
      "GenetaredBy": 139,
      "TemplateName": codeDialog,
      "agreements": finalitems
    });
    var response = await dio.post(
      'https://eastbridge.online/apicore/api/AgreementTemplate/AgreementTemplates',
      data: data,
